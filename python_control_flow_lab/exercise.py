...
def calculate_dog_years():
  ...
  dogs_age=int(input("Please enter a dog's age:"))
  if dogs_age <0:
            print('please enter a valid age')
  elif dogs_age <=2:
           age= dogs_age * 10
           print(f'The dogs age in dog years is {age}')
  else:
            age= 20 + (dogs_age - 2) * 7
            print(f'The dogs age in dog years is {age}')
# Call the function
...
def weather_advice():
    # Your control flow logic goes here
  is_it_cold=input('Please enter if it is cold yes/no:')
  is_it_raining=input('Please enter if it is raining yes/no:')
